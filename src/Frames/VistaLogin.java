...
public class VistaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(110, 110, 190, 170);
        ...
        jButton1.setBounds(230, 370, 80, 22);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/JE_opt (3).jpg"))); // NOI18N
        jPanel1.add(jLabel6);
    ...
    private void mostrarPanelMesero() {
        PanelMesero panelMesero = new PanelMesero();
        setContentPane(panelMesero);
        revalidate();
        repaint();
    }

    private void mostrarPanelCocinero() {
        PanelCocinero panelCocinero = new PanelCocinero();
        setContentPane(panelCocinero);
        revalidate();
        repaint();
    }
